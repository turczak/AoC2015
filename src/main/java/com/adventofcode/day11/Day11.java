...
public class Day11 {
    ...
    private boolean checkIfValid(String password) {
        return increasingStraightOfThreeLetters(password) && password.matches(BANNED_LETTERS) && password.matches(TWO_DIFFERENT_NON_OVERLAPPING_PAIRS);
    }

    public boolean increasingStraightOfThreeLetters(String password) {
